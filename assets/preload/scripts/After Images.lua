...
function goodNoteHit(id, direction, noteType, isSustainNote)
  ...
  if _G['gfGhostData.strumTime'] == getPropertyFromGroup('notes', id, 'strumTime') and not isSustainNote and gfSection == true then
    createGhost('gf')
  end
  if not isSustainNote and gfSection == true then
...
function opponentNoteHit(id, direction, noteType, isSustainNote)
  if _G['dadGhostData.strumTime'] == getPropertyFromGroup('notes', id, 'strumTime') and not isSustainNote and not gfSection == true then
    createGhost('dad')
  end
  if not isSustainNote and not gfSection == true then
