...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.frames = Paths.getSparrowAtlas('vloologoBump');
		...
		ourple = new FlxSprite(600, FlxG.height - 920);
		ourple.loadGraphic(Paths.image('vlootitle', 'preload'));
		ourple.scale.set(1, 1);
		...
		vhsFx.frames = Paths.getSparrowAtlas('vloo_static');
		vhsFx.animation.addByPrefix('scallywags instance', 'scallywags instance', 24, true);
		vhsFx.animation.play('scallywags instance');
		vhsFx.screenCenter();
